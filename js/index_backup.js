...
var app = { 
	...
	getUsers: function(){
		...
		if(app.action == 'getOnlineNow'){					
			app.requestUrl = 'http://m.richdate.co.il/api/v1/users/online/'+app.itemsPerPage+'/'+app.pageNumber;
		}	
			...
			app.requestUrl = 'http://m.richdate.co.il/api/v1/users/search/region:'+region+'/age:'+ageFrom+'-'+ageTo+'/userGender:'+userGender+'/nickName:'+nickName+'/count:'+app.itemsPerPage+'/page:'+app.pageNumber;
		}	
		else if(app.action == 'getStatResults'){					
			app.requestUrl = 'http://m.richdate.co.il/api/v1/user/statistics/'+app.statAction+'/count:'+app.itemsPerPage+'/page:'+app.pageNumber;
		}
